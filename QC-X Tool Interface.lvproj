	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				...
				<Item Name="MGI Degrees to Radians [DBL].vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Degrees to Radians/MGI Degrees to Radians [DBL].vi"/>
				<Item Name="MGI Degrees to Radians [SGL].vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Degrees to Radians/MGI Degrees to Radians [SGL].vi"/>
				<Item Name="MGI Degrees to Radians DBL.vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Degrees to Radians/MGI Degrees to Radians DBL.vi"/>
				<Item Name="MGI Degrees to Radians SGL.vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Degrees to Radians/MGI Degrees to Radians SGL.vi"/>
				<Item Name="MGI Degrees to Radians.vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Degrees to Radians.vi"/>
				...
				<Item Name="MGI Radians to Degrees [DBL].vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Radians to Degrees/MGI Radians to Degrees [DBL].vi"/>
				<Item Name="MGI Radians to Degrees [SGL].vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Radians to Degrees/MGI Radians to Degrees [SGL].vi"/>
				<Item Name="MGI Radians to Degrees DBL.vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Radians to Degrees/MGI Radians to Degrees DBL.vi"/>
				<Item Name="MGI Radians to Degrees SGL.vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Radians to Degrees/MGI Radians to Degrees SGL.vi"/>
				<Item Name="MGI Radians to Degrees.vi" Type="VI" URL="/&lt;userlib&gt;/_MGI/Numeric/Coercion/MGI Radians to Degrees.vi"/>
			...
			<Item Name="_FPGA Return Setup Data Cluster--typedef.ctl" Type="VI" URL="../Tool Typedefs/_FPGA Return Setup Data Cluster--typedef.ctl"/>
			<Item Name="ACME.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/ACME/ACME.lvlib"/>
			<Item Name="Advapi32.dll" Type="Document" URL="Advapi32.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Algorithm Process.lvclass" Type="LVClass" URL="../../QC-X App/Proc Algorithms/Algorithm Proc Interface Class/Algorithm Process.lvclass"/>
			<Item Name="API Round.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/API Round/API Round.lvlib"/>
			<Item Name="App Config.lvlib" Type="Library" URL="../../QC-X App/App Config/App Config.lvlib"/>
			<Item Name="App User Events Library.lvlib" Type="Library" URL="../../QC-X App/UI/App User Events Library/App User Events Library.lvlib"/>
			<Item Name="Average.vi" Type="VI" URL="../../QC-X App/Utility/Average.vi"/>
			<Item Name="Blowfish Encipher Decipher.vi" Type="VI" URL="../../Blowfish Encryption/LabVIEW Blowfish Encryption/Blowfish Encipher Decipher.vi"/>
			<Item Name="Blowfish Encryption.vi" Type="VI" URL="../../Blowfish Encryption/LabVIEW Blowfish Encryption/Blowfish Encryption.vi"/>
			<Item Name="Blowfish F(X).vi" Type="VI" URL="../../Blowfish Encryption/LabVIEW Blowfish Encryption/Blowfish F(X).vi"/>
			<Item Name="Blowfish Init.vi" Type="VI" URL="../../Blowfish Encryption/LabVIEW Blowfish Encryption/Blowfish Init.vi"/>
			<Item Name="Boolean to Text.vi" Type="VI" URL="../../QC-X App/Libraries/Event Logger Library/Logging Support/Boolean to Text.vi"/>
			<Item Name="Buttress.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Gen Buttress/Buttress.lvlib"/>
			<Item Name="Cal Utility Common.lvlib" Type="Library" URL="../../QC-X App/Cal Utility App/Common/Cal Utility Common.lvlib"/>
			<Item Name="CAL_Check.lvlib" Type="Library" URL="../../QC-X App/Verification/CAL_Check.lvlib"/>
			<Item Name="Calibration.lvlib" Type="Library" URL="../../QC-X App/Calibration/Calibration.lvlib"/>
			<Item Name="Combine Probes.lvlib" Type="Library" URL="../../QC-X App/Combine Probes/Combine Probes.lvlib"/>
			<Item Name="Config_GXML_File.lvclass" Type="LVClass" URL="../../QC-X App/App Support/Classes/Config GXML File/Config_GXML_File.lvclass"/>
			<Item Name="Create Dir(recursive).vi" Type="VI" URL="../../QC-X App/File Manager/Support/Create Dir(recursive).vi"/>
			<Item Name="Details Display Dialog(nonModal).vi" Type="VI" URL="../../QC-X App/Utility/Details Display Dialog(nonModal).vi"/>
			<Item Name="Display Fill To Control Typedef.ctl" Type="VI" URL="../../QC-X App/UI/Display Fill To Control Typedef.ctl"/>
			<Item Name="Display Overlay.lvlib" Type="Library" URL="../../QC-X App/Libraries/Display Overlay/Display Overlay.lvlib"/>
			<Item Name="EventBuffer.lvclass" Type="LVClass" URL="../../QC-X App/Libraries/Event Logger Library/Event Buffer/EventBuffer.lvclass"/>
			<Item Name="EventLog.lvclass" Type="LVClass" URL="../../QC-X App/Libraries/Event Logger Library/Event Log/EventLog.lvclass"/>
			<Item Name="File Manager.lvlib" Type="Library" URL="../../QC-X App/File Manager/File Manager.lvlib"/>
			<Item Name="Flatness Cal.lvlib" Type="Library" URL="../../QC-X App/Flatness Calibration/Flatness Cal.lvlib"/>
			<Item Name="Format Boolean Descriptor.vi" Type="VI" URL="../../QC-X App/Libraries/Event Logger Library/Logging Support/Format Boolean Descriptor.vi"/>
			<Item Name="Get Software Version.vi" Type="VI" URL="../../QC-X App/Version/Get Software Version.vi"/>
			<Item Name="Hex to U32.vi" Type="VI" URL="../../Blowfish Encryption/LabVIEW Blowfish Encryption/Hex to U32.vi"/>
			<Item Name="Inspection Mgr.lvlib" Type="Library" URL="../../QC-X App/Inspection Mgr/Inspection Mgr.lvlib"/>
			<Item Name="Inspection Setup.lvlib" Type="Library" URL="../../QC-X App/Libraries/Inspection Setup/Inspection Setup.lvlib"/>
			<Item Name="kernel32.dll" Type="Document" URL="kernel32.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Log Tool Module Generic(OnEntry).vi" Type="VI" URL="../../QC-X App/Libraries/Event Logger Library/Logging Support/Log Tool Module Generic(OnEntry).vi"/>
			<Item Name="Log Tool Module Generic.vi" Type="VI" URL="../../QC-X App/Libraries/Event Logger Library/Logging Support/Log Tool Module Generic.vi"/>
			<Item Name="LogFile CSV.lvclass" Type="LVClass" URL="../../QC-X App/Libraries/Event Logger Library/LogFile CSV/LogFile CSV.lvclass"/>
			<Item Name="LogFile Generic.lvclass" Type="LVClass" URL="../../QC-X App/Libraries/Event Logger Library/LogFile Generic/LogFile Generic.lvclass"/>
			<Item Name="LogFile TDMS.lvclass" Type="LVClass" URL="../../QC-X App/Libraries/Event Logger Library/LogFle TDMS/LogFile TDMS.lvclass"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="Measurement Display.lvlib" Type="Library" URL="../../QC-X App/Measurement Display/Measurement Display.lvlib"/>
			<Item Name="Measurement Process.lvclass" Type="LVClass" URL="../../QC-X App/Proc Algorithms/Measurement Proc Interface Class/Measurement Process.lvclass"/>
			<Item Name="Measurements.lvlib" Type="Library" URL="../../QC-X App/Measurements/Measurements.lvlib"/>
			<Item Name="Mod Buttress.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Mod Buttress/Mod Buttress.lvlib"/>
			<Item Name="MultiPeak Display.lvlib" Type="Library" URL="../../QC-X App/Libraries/MultiPeak Display/MultiPeak Display.lvlib"/>
			<Item Name="MultiPeakProc.lvlib" Type="Library" URL="../../QC-X App/MultiPeakProc/MultiPeakProc.lvlib"/>
			<Item Name="Overlay Display.rtm" Type="Document" URL="../../QC-X App/Libraries/Display Overlay/Overlay Display.rtm"/>
			<Item Name="Overlay.lvlib" Type="Library" URL="../../QC-X App/Templates/Overlay/Overlay.lvlib"/>
			<Item Name="ProbeProcessing.lvlib" Type="Library" URL="../../QC-X App/ProbeProc/ProbeProcessing.lvlib"/>
			<Item Name="Profile.lvlib" Type="Library" URL="../../QC-X App/Templates/Profile/Profile.lvlib"/>
			<Item Name="ProgressBarWithOffset.lvclass" Type="LVClass" URL="../../QC-X App/UI/ProgressBarWithOffset/ProgressBarWithOffset.lvclass"/>
			<Item Name="ProgressBarWrapper.lvclass" Type="LVClass" URL="../../QC-X App/UI/ProgressBarWrapper/ProgressBarWrapper.lvclass"/>
			<Item Name="Read and Parse GXML file Error Check.vi" Type="VI" URL="../../QC-X App/UI/Read and Parse GXML file Error Check.vi"/>
			<Item Name="Reason String from Error Code.vi" Type="VI" URL="../../QC-X App/Utility/Reason String from Error Code.vi"/>
			<Item Name="SampleProcessing.lvlib" Type="Library" URL="../../QC-X App/SampleProc/SampleProcessing.lvlib"/>
			<Item Name="ScanProcessing.lvlib" Type="Library" URL="../../QC-X App/ScanProc/ScanProcessing.lvlib"/>
			<Item Name="Seal Processing.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Seals/Seal Processing.lvlib"/>
			<Item Name="Search 1D Array for All (U8).vi" Type="VI" URL="../../QC-X App/Utility/Search 1D Array for All (U8).vi"/>
			<Item Name="Search or Split String.vi" Type="VI" URL="../../QC-X App/Utility/Search or Split String.vi"/>
			<Item Name="Select Enab-Disable for Control.vi" Type="VI" URL="../../QC-X App/Utility/Select Enab-Disable for Control.vi"/>
			<Item Name="SensorProcessing.lvlib" Type="Library" URL="../../QC-X App/SensorProc/SensorProcessing.lvlib"/>
			<Item Name="Setup.lvlib" Type="Library" URL="../../QC-X App/Libraries/Setup/Setup.lvlib"/>
			<Item Name="Templates.lvlib" Type="Library" URL="../../QC-X App/Templates/Templates/Templates.lvlib"/>
			<Item Name="ThreadformProcessing.lvlib" Type="Library" URL="../../QC-X App/Threadform/ThreadformProcessing.lvlib"/>
			<Item Name="Tool Handler.lvlib" Type="Library" URL="../../QC-X App/Tool Handler Support/Tool Handler.lvlib"/>
			<Item Name="UAC Module.lvlib" Type="Library" URL="../../QC-X App/Libraries/UAC Module/UAC Module.lvlib"/>
			<Item Name="user32.dll" Type="Document" URL="user32.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="USS Eagle Seals.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Seals/USS Eagle/USS Eagle Seals.lvlib"/>
			<Item Name="USS Liberty Seals.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Seals/USS Liberty/USS Liberty Seals.lvlib"/>
			<Item Name="Verification Processing.lvlib" Type="Library" URL="../../QC-X App/Validation/Verification Processing.lvlib"/>
			<Item Name="VersionGLOB.vi" Type="VI" URL="../../QC-X App/Version/VersionGLOB.vi"/>
			<Item Name="Wait (with data flow).vi" Type="VI" URL="../../QC-X App/Utility/Wait (with data flow).vi"/>
			<Item Name="Wedge.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/WEDGE/Wedge.lvlib"/>
		</Item>
