...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Dialog Boxes(non-blocking).lvlib" Type="Library" URL="../../QC-X App/Dialog Boxes(non-blocking)/Dialog Boxes(non-blocking).lvlib"/>
			...
			<Item Name="Overlay Display 2.lvlib" Type="Library" URL="../../QC-X App/Libraries/Overlay Display 2/Overlay Display 2.lvlib"/>
			<Item Name="Overlay Display.lvlib" Type="Library" URL="../../QC-X App/Libraries/Overlay Display/Overlay Display.lvlib"/>
			<Item Name="Overlay Fit.lvlib" Type="Library" URL="../../QC-X App/Libraries/Overlay Fit/Overlay Fit.lvlib"/>
			<Item Name="Overlay.lvlib" Type="Library" URL="../../QC-X App/Templates/Overlay/Overlay.lvlib"/>
			<Item Name="OverlayFit Menu.rtm" Type="Document" URL="../../QC-X App/Libraries/Overlay Fit/OverlayFit Menu.rtm"/>
			...
			<Item Name="Read Local Tool Cfg XML File.vi" Type="VI" URL="../../QC-X App/Setup Utilites/Read Local Tool Cfg XML File.vi"/>
			<Item Name="Round Filter.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Round/Round Filter/Round Filter.lvlib"/>
			<Item Name="Round Profile.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/Round/Round Profile.lvlib"/>
			...
			<Item Name="TEST Read  and Display Overlay.vi" Type="VI" URL="../../QC-X App/Templates/TEST Read  and Display Overlay.vi"/>
			<Item Name="ThreadformProcessing.lvlib" Type="Library" URL="../../QC-X App/Threadform/ThreadformProcessing.lvlib"/>
			<Item Name="TMK UP SF.lvlib" Type="Library" URL="../../QC-X App/Proc Algorithms/TMK UP SF/TMK UP SF.lvlib"/>
			<Item Name="UAC Module.lvlib" Type="Library" URL="../../UAC Module/Libraries/UAC Module/UAC Module.lvlib"/>
			...
			<Item Name="Write Array of Ctrl Refs to Config File.vi" Type="VI" URL="../../QC-X App/Utility/Write Array of Ctrl Refs to Config File.vi"/>
		</Item>
